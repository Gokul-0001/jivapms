...
# ============================================================= #
@login_required
def list___pluralmodname__(request, __connectid__):
    # take inputs
    # process inputs
    user = request.user       
    objects_count = 0    
    ...
    if search_query:
        ...
        tobjects = __modelname__.objects.filter(active=True, __connectid__=__connectid__, **viewable_dict).order_by('position')
        ...
        if 'selected_item' in request.POST:  
            ...
            for item_id in selected_items:
                ...
                if bulk_operation == 'bulk_delete':
                    ...
                    return redirect('list___pluralmodname__', __connectid__=__connectid__)
            return redirect('list___pluralmodname__', __connectid__=__connectid__)
...
# ============================================================= #
@login_required
def list_deleted___pluralmodname__(request, __connectid__):
    # take inputs
    # process inputs
    user = request.user        
    objects_count = 0    
    ...
    if search_query:
        ...
        tobjects = __modelname__.objects.filter(active=False, deleted=False, 
                                                __connectid__=__connectid__,
                                                **viewable_dict).order_by('position')
        ...
        if 'selected_item' in request.POST:  
                ...
                for item_id in selected_items:
                    ...
                    if bulk_operation == 'bulk_restore':
                        ...
                        return redirect('list_deleted___pluralmodname__', __connectid__)
                return redirect('list_deleted___pluralmodname__', __connectid__=__connectid__)
...
# Create View
@login_required
def create___singularmodname__(request, __connectid__):
    user = request.user
    # connect with connect id
    __connectstr__ = get_object_or_404(__connectmoduletitle__, pk=__connectid__, **viewable_dict)
    if request.method == 'POST':
...
# Edit
@login_required
def edit___singularmodname__(request, __connectid__ , super_type_id):
    user = request.user
    # connect with connect id
    __connectstr__ = get_object_or_404(__connectmoduletitle__, pk=__connectid__, **viewable_dict)
...
@login_required
def delete___singularmodname__(request, __connectid__ ,super_type_id):
    user = request.user
    # connect with connect id
    __connectstr__ = get_object_or_404(__connectmoduletitle__, pk=__connectid__, **viewable_dict)
    object = get_object_or_404(__modelname__, pk=super_type_id, active=True, **viewable_dict)
...
@login_required
def permanent_deletion___singularmodname__(request, __connectid__ ,super_type_id):
    user = request.user
    # connect with connect id
    __connectstr__ = get_object_or_404(__connectmoduletitle__, pk=__connectid__, **viewable_dict)
...
@login_required
def restore___singularmodname__(request, __connectid__, super_type_id):
    user = request.user
    # connect with connect id
    __connectstr__ = get_object_or_404(__connectmoduletitle__, pk=__connectid__, **viewable_dict)
...
@login_required
def view___singularmodname__(request,  __connectid__, super_type_id):
    user = request.user
    # connect with connect id
    __connectstr__ = get_object_or_404(__connectmoduletitle__, pk=__connectid__, **viewable_dict)
    object = get_object_or_404(__modelname__, pk=super_type_id, active=True, **viewable_dict)    
