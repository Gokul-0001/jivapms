...
# Edit
@login_required
def edit___singularmodname__(request, parent_id,  content_type_id):
    user = request.user
    ref_parent_id = parent_id
    parent_id = None if parent_id == 0 else parent_id
    viewable_dict, first_viewable_dict = get_viewable_dicts(request.user, 
...
@login_required
def delete___singularmodname__(request, parent_id, content_type_id):
    user = request.user
    ref_parent_id = parent_id
    parent_id = None if parent_id == 0 else parent_id
    viewable_dict, first_viewable_dict = get_viewable_dicts(request.user, 
...
@login_required
def permanent_deletion___singularmodname__(request, parent_id, content_type_id):
    user = request.user
    ref_parent_id = parent_id
    parent_id = None if parent_id == 0 else parent_id
    viewable_dict, first_viewable_dict = get_viewable_dicts(request.user, 
...
@login_required
def restore___singularmodname__(request, parent_id, content_type_id):
    user = request.user
    ref_parent_id = parent_id
    parent_id = None if parent_id == 0 else parent_id
    viewable_dict, first_viewable_dict = get_viewable_dicts(request.user, 
                                viewable_flag, first_viewable_flag)
    object = get_object_or_404(__modelname__, pk=content_type_id, active=False, **viewable_dict)
    object.active = True
    object.save()
    return redirect('list___pluralmodname__', parent_id=ref_parent_id)
...
@login_required
def view___singularmodname__(request, parent_id,  content_type_id):
    user = request.user
    ref_parent_id = parent_id
    parent_id = None if parent_id == 0 else parent_id
    viewable_dict, first_viewable_dict = get_viewable_dicts(request.user, 
