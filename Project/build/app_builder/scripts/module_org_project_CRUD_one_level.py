                            ...
                            <div class="container-fluid-width">
                                <div class="row pb-2">
                                    <div class="col col-md-5">                                
                                        <b class="h3">
                                        <a href="{% url 'list___pluralfirstmodname___' ___firstid___ %}" style="text-decoration: none;">
                                            {{organization}}
                                        </a>
                                        </b>
                                        &nbsp;&nbsp;
                                    ...
                                    <div class="col col-md-3 text-end">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="{% url 'list___pluralfirstmodname___' ___firstid___ %}" class="btn btn-primary">
