...
urlpatterns = [
    ...
    path('list_org_iterations/<int:org_release_id>/', views_org_iteration.list_org_iterations, name='list_org_iterations'),
    path('list_deleted_org_iterations/<int:org_release_id>/', views_org_iteration.list_deleted_org_iterations, name='list_deleted_org_iterations'),
    path('create_org_iteration/<int:org_release_id>/', views_org_iteration.create_org_iteration, name='create_org_iteration'),
    path('edit_org_iteration/<int:org_release_id>/<int:org_iteration_id>/', views_org_iteration.edit_org_iteration, name='edit_org_iteration'),
    path('delete_org_iteration/<int:org_release_id>/<int:org_iteration_id>/', views_org_iteration.delete_org_iteration, name='delete_org_iteration'),
