...
urlpatterns = [
    ...
    path('project_workflow/', include('app_organization.mod_project_workflow.urls_project_workflow')),
    path('project_workflow_step/', include('app_organization.mod_project_workflow_step.urls_project_workflow_step')),
