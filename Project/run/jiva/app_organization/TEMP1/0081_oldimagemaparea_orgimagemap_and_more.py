# Generated by Django 5.0.3 on 2024-11-26 18:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='author_org_image_maps', to=settings.AUTH_USER_MODEL)),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='organization_org_image_maps', to='app_organization.organization')),
            ],
            options={
                'ordering': ['position'],
                'abstract': False,
